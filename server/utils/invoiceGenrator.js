...
export const generateInvoice = (user, membership) => {
  return new Promise((resolve, reject) => {
    try {
      ...
      doc
        ...
        .text(`Type: Purchase`)
        .moveDown(0.3)
        .text(`Item: ${membership.type}`)
        .moveDown(0.3)
        .text(`Price: Rs. ${membership.price}`)
        .moveDown(0.3)
      ...
      doc
        ...
        .fillColor("#007bff")
        .font("Helvetica-Bold")
        .text(`Total Amount Paid: Rs. ${membership.price}`, { align: "right" })
        .moveDown(2);
